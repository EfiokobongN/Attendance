<?php 
    class crud{
        ...
        public function insertattendance($fname, $lname, $dob, $email,$contact,$specialty,$avatar_path){
            try {
                // define sql statement to be executed
                $sql = "INSERT INTO attendance (firstname,lastname,dateofbirth,emailaddress,contactnumber,specialty_id,avatar_path) VALUES (:fname,:lname,:dob,:email,:contact,:specialty,:avatar_path)";
